...
function HideOnScroll(props) {
    ...
    return (<Slide appear={false}
        direction="down" in={!trigger} > {children} </Slide>
    );
}
            ...
            .then(
                res => {
                    const resp = res.items.map(img => {
                        const [pid, ind, pre, w, h, title, author, aid, tags] = img;
                        const nav = `/${pid}/${ind}`;
                        return {
                            pid,
                            ind,
            ...
            >
                ...
                <div
                    ...
                    <List className={classes.list}>
                        <UpscalingItem on_confirm={this.close_drawer} />
                        <ListItem
                            button
                            key="refresh"
